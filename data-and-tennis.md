...
I'm a lifelong tennis player and have stayed active in the game as a player, community organizer at the [Fort Greene Tennis Association](http://www.fortgreenetennis.org/), former Data Engineer at [Universal Tennis](https://www.universaltennis.com/), and through a side business with my friend called [Bageled NYC](https://bageled.nyc/):

## Bageled NYC

I'm working with a creative partner on a project called [Bageled NYC](https://www.bageled.nyc/), where create and sell bagel-inspired tennis gear and merch (in tennis, a score of 6-0 is also called a "bagel"). I've worked on everything from illustration to production sourcing to social media outreach. But one of my main projects was to create our website, which has steadily evolved and now includes [a fun leaderboard](https://bageled.nyc/bagel-race) showing which pro tennis players have the most bagels on tour:
<br>
<br>
